...
export interface ApiAthleteAthlete extends Schema.CollectionType {
  ...
  attributes: {
    ...
    sexe: Attribute.Enumeration<['M', 'F']>;
    poids: Attribute.String;
    categorie: Attribute.String;
    club: Attribute.String;
    cercle: Attribute.String;
    entente: Attribute.String;
    ligue: Attribute.String;
    grade: Attribute.String;
    licences: Attribute.Relation<
      'api::athlete.athlete',
      'oneToMany',
      'api::licence.licence'
    >;
...
export interface ApiLicenceLicence extends Schema.CollectionType {
  ...
  attributes: {
    ...
    date_delivrance: Attribute.Date;
